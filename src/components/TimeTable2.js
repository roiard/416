                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="active" style={{ padding: '5px' }}>
                                        ...
                                        <div className="course-display">
                                            <div className="detail-course" draggable="true" onDragStart={(event) => event.dataTransfer.setData("text/plain", null)}>
                                                <div className="course-number">AMS 151</div>
                                                <div className="room-number">B 105</div>
                                            </div>
                                            <div className="hover">
                                                <div className="course-number">AMS 1511</div>
                                                <div className="professor-name">A. Mione</div>
                                                <div className="room-number">B 105</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="active" style={{ padding: '5px' }}>
                                        ...
                                        <div className="course-display">
                                            <div className="detail-course" draggable="true">
                                                <div className="course-number">AMS 301</div>
                                                <div className="room-number">B 105</div>
                                                <div className="hover">
                                                    <div className="course-number">AMS 4444</div>
                                                    <div className="professor-name">A. Mione</div>
                                                    <div className="room-number">B 105</div>
                                                </div>
                                            </div>
                                            <div className="detail-course" draggable="true">
                                                <div className="course-number">AMS 412</div>
                                                <div className="room-number">B 105</div>
                                                <div className="hover">
                                                    <div className="course-number">AMS 666666666</div>
                                                    <div className="professor-name">A. Mione</div>
                                                    <div className="room-number">B 105</div>
                                                </div>
                                            </div>
